...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.76\textwidth}
    \centering
    \includegraphics[width=\textwidth]{imgs/ber-simulations/SSK BER Performance with RIS (K=2, N=16, J=1, M=1).pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{imgs/ber-simulations/SSK BER Performance with RIS (K=2, N=16, J=2, M=1).pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{imgs/ber-simulations/SSK BER Performance with RIS (K=2, N=16, J=1, M=2).pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{imgs/ber-simulations/SSK BER Performance with RIS (K=2, N=16, J=2, M=2).pdf}
